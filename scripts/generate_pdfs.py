    ...
    'tr': {
        ...
        'slides': [
            ('GOR SARGSYAN', 'Yapay Zeka Enstrumanlari & Ekonomik Otomasyon Stratejisi',
             'Uctan uca otonom donusum mimarisi.'),
            ('Ozgecmis', 'Ekonomist ve AI Muhendisi',
    ...
    'en': {
        ...
        'slides': [
            ('GOR SARGSYAN', 'AI Instruments & Economic Automation Strategy',
             'End-to-end autonomous transformation architecture for businesses.'),
            ('Profile', 'Economist and AI Engineer',
    ...
    'es': {
        ...
        'slides': [
            ('GOR SARGSYAN', 'Instrumentos IA y Estrategia de Automatizacion Economica',
             'Transformacion autonoma integral para empresas.'),
            ('Perfil', 'Economista e Ingeniero de IA',
    ...
    'ru': {
        ...
        'slides': [
            ('GOR SARGSYAN', 'ИИ Инструменты и Стратегия Экономической Автоматизации',
             'Сквозная автономная трансформация для бизнеса.'),
            ('Профиль', 'Экономист и ИИ-инженер',
    ...
    'hy': {
        ...
        'slides': [
            ('GOR SARGSYAN', 'AI Գործիքներ և Տնտեսական Ավտոմատացման Ռազմավարություն',
             'Բիզնեսների համար լիարժեք ինքնավար փոխակերպման ճարտարապետություն։'),
            ('Կենսագրություն', 'Տնտեսագետ և AI Ինժեներ',
